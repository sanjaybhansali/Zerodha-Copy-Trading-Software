...
<p>
                <strong>Zerodha Copy Trading Software  For Indian Broker </strong> - is Copy Trading software for Major Zerodha broker
                </p>
<ul>
<li>
...
<li>
					    Broker Client Code:  Enter Your   Client Code</li>
<li>
					     Broker Password :  Enter Your Broker Password (For Angel you need to Enter your  MPIN)
					  </li>
<li>
					     TOTP Key :  Enter Your   Account Totp key (You must enable TOTP option on Broker website)
					  </li>
<li>
